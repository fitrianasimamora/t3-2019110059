        ...
        <div class="col-md-6 mb-3">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" step="0.1" class="form-control @error('penerbit') is-invalid @enderror"
                    name="penerbit" id="penerbit" min="1" max="5" value="{{ old('penerbit') }}">
                @error('penerbit')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
            <div class="col-md-6 mb-3">
                ...
                <input type="text" step="0.1" class="form-control @error('author_id') is-invalid @enderror"
                    name="author_id" id="author_id" min="1" max="5" value="{{ old('author_id') }}">
                @error('author_id')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
